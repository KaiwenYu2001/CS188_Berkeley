...
def joinFactors(factors: List[Factor]):
    ...
    # Combine all unconditioned and conditioned variables from input factors
    ...
    # Create a new factor with the combined set of variables
    new_factor = Factor(unconditioned, conditioned, factor.variableDomainsDict())

    # Compute the probability entries of the new factor
...
def eliminateWithCallTracking(callTrackingList=None):
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        "*** YOUR CODE HERE ***"
        newvariables = factor.unconditionedVariables() - {eliminationVariable}
        newfactor = Factor(newvariables, factor.conditionedVariables(), factor.variableDomainsDict())
        ...
        for assignment in newfactor.getAllPossibleAssignmentDicts():
            ...
            for value in factor.variableDomainsDict()[eliminationVariable]:
                ...
                summed_prob += factor.getProbability(assignment)

            newfactor.setProbability(assignment, summed_prob)
        return newfactor
